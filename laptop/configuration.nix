...
users.users.michael = {
  ...
  environment.systemPackages = with pkgs; [ libreoffice duckstation pcsx2 discord r2modman steamguard-cli libheif ff2mpv mpv gimp-with-plugins inkscape lutgen-rs ];
